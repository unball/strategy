...
{
    float target_position_x[6] = {0.37, 0.37, 0.60, -0.37, -0.37, -0.60};
    float target_position_y[6] = {0.40, -0.40, 0.0, 0.40, -0.40, 0.0};
...
void TrajectoryController::turn(int robot_number, float angle)
{
    ...
    float angle_error = math::reduceAngle(robot[robot_number].getTh());
...
{
    robot[robot_number].setTargetX(0);
